...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-3.5 bg-[#F5EDDA] ">
        <NavLink  to="/">
          <img className='h-[60px] w-[60px] ml-20' src={Logo} alt="Logo" />
        </NavLink>
      ...
      <div className=" bg-[#2B3C58] h-[100%] no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
